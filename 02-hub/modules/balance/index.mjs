...
const insights = `<div class="balance-insights"><section class="balance-panel"><div class="balance-title"><h2>Валюты</h2><span>₽ за 1</span></div><div id="balanceFiat" class="balance-quotes">Загрузка…</div><p id="balanceFiatDate" class="balance-source"></p></section><section class="balance-panel"><div class="balance-title"><h2>Криптовалюты</h2><span>USD</span></div><div id="balanceCrypto" class="balance-quotes">Загрузка…</div><p id="balanceCryptoDate" class="balance-source"></p></section><section class="balance-panel balance-ai"><div class="balance-title"><h2>ИИ · остатки</h2></div><div id="balanceAI"><div class="balance-credit-row"><span>DeepSeek</span><strong id="balanceCredit">—</strong></div><div class="balance-credit-row"><span>FlowMusic</span><strong id="balanceFlowCredit">—</strong></div></div></section></div>`;
