      ...
      try {
        ...
        if (['GET', 'HEAD'].includes(request.method)) {
          ...
          if (route.startsWith('/audio/'))
            return searchParams.has('format')
              ? await audio.download(route.slice(7), request, searchParams.get('format'))
              : audio.serve(route.slice(7), request, searchParams.has('download'));
