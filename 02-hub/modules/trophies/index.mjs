...
const content = `${head}<section id="trophiesPage">${status}<nav class="trophy-tabs" aria-label="Библиотека игр"><a href="/modules/trophies/" data-trophy-provider="">Все</a><a href="/modules/trophies/?provider=steam" data-trophy-provider="steam">Steam</a><a href="/modules/trophies/?provider=ra" data-trophy-provider="ra">RetroAchievements</a></nav><div class="trophy-toolbar"><input id="trophySearch" type="search" placeholder="Найти игру" aria-label="Найти игру" maxlength="200"><select id="trophyFilter" aria-label="Прогресс"><option value="">Все игры</option><option value="started">Начатые</option><option value="beaten">Пройдены</option><option value="complete">100%</option></select><select id="trophyMode" aria-label="Режим RetroAchievements"><option value="soft">RA · Softcore</option><option value="hard">RA · Hardcore</option></select><button id="trophySync">Обновить</button></div><p id="trophyModeHelp" class="trophy-muted">Softcore включает открытия в Hardcore. «Пройдена» — награда RA или твоя отметка Steam.</p><div id="trophyAccounts" class="trophy-meta"></div><p id="trophyCount" class="trophy-muted"></p><div id="trophyGames" class="trophy-grid"></div><details><summary>Активность · 12 недель · UTC</summary><div id="trophyCalendar" class="trophy-calendar"></div><p class="trophy-muted">Только достижения с известной датой открытия.</p></details><details><summary>Редкие достижения · до 5%</summary><div id="trophyRare"></div></details><details id="trophyAwardsSection"><summary>Награды RetroAchievements</summary><div id="trophyAwards"></div></details><dialog id="trophyDialog" aria-labelledby="trophyDialogTitle"><div class="trophy-meta"><h2 id="trophyDialogTitle"></h2><button id="trophyClose" class="dialog-close" aria-label="Закрыть">×</button></div><p id="trophyDetailStatus"></p><div class="trophy-toolbar"><select id="trophyUnlockFilter" aria-label="Достижения"><option value="all">Все</option><option value="unlocked">Открытые</option><option value="locked">Оставшиеся</option></select><button id="trophyBeaten" hidden>Отметить прохождение</button></div><div id="trophyAchievements"></div></dialog></section>`;
