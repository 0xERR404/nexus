...
if is_done "hub_4b_bridge"; then
    ...
    if ! command -v node >/dev/null 2>&1; then
        NODE_MAJOR=20
        run_spinner "Установка ключа NodeSource" \
            "mkdir -p /usr/share/keyrings && curl -fsSL https://deb.nodesource.com/gpgkey/nodesource-repo.gpg.key | gpg --dearmor -o /usr/share/keyrings/nodesource.gpg"
