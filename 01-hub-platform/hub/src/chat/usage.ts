...
export interface UsageSummary {
  ...
  // Скользящее окно (не календарная граница) — "месяц" = 30 дней.
...
// Реальные числа из ответа API (FlowMusic не попадает — генерация аудио).
...
// Журнал — единственный источник правды, суммируем заново на каждый запрос.
