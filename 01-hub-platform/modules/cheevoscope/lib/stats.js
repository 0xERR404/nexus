...
function createStats({ steamApi, cache, paths, apiConcurrency = 10, storeConcurrency = 5, logger = console }) {
  ...
  // Первичный источник — страница профиля (полнее GetOwnedGames для
  // части аккаунтов), тот — обогащение playtime. Предыдущий сохранённый
  // список читается первым базой, чтобы appid не терялся.
