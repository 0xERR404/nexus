...
const EXTRA_SCRIPT = `
  ...
  // Имя сервера — данные, введённые снаружи (POST /api/agent/report).
  // Раньше вставлялось в innerHTML как есть — постоянный XSS. Экранируем
  // везде, где имя идёт в разметку.
