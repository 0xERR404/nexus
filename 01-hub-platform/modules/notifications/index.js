...
// Журнал событий (локальные через хаб + удалённые от агентов) и push
// (каждое событие отдельным уведомлением). Сама отправка push — на
// стороне хаба (push.ts), модуль просит через /internal/send-push.
