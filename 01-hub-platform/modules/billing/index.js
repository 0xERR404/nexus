...
// 4 карточки-провайдера: баланс (только у DeepSeek есть публичный
// эндпоинт) и токены за час/сутки/месяц/всё время (скользящие окна,
// см. usage.ts). Ключи сюда не попадают, только готовый результат от хаба.
